$(document).ready(function(){
    $('.interface__carousel').slick({
      ...
      prevArrow: '<button type="button" class="slick-prev"><img src="OCP/icons/3_section/left.svg"></button>',
      nextArrow: '<button type="button" class="slick-next"><img src="OCP/icons/3_section/right.svg"></button>',
      responsive:[
        {
            breakpoint: 621,
            settings: {
